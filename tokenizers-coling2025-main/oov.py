...
if __name__ == "__main__":
    ...
    # Update the model path to the correct file
    sp.load("c:/Users/ROSHINI PRIYA/Downloads/tokenizers-coling2025-main (4)/tokenizers-coling2025-main/gemma-3-270m/tokenizer.model")

    # Add unk_id attribute if not present
    if not hasattr(sp, "unk_id"):
        sp.unk_id = sp.piece_to_id("<unk>")

run_oov_eval("data/train.txt", "data/test.txt", sp, exp_name="V0-Baseline")
